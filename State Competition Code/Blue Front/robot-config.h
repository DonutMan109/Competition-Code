...
void botFlag(){
    RightDrive1.rotateFor(0.5, vex::rotationUnits::rev, 30, vex::velocityUnits::pct, false);
    RightDrive2.rotateFor(0.5, vex::rotationUnits::rev, 30, vex::velocityUnits::pct, true);
}

void angle(double spin){ //.1 for top flag
    RightDrive1.rotateFor(spin, vex::rotationUnits::rev, 30, vex::velocityUnits::pct, false);
    RightDrive2.rotateFor(spin, vex::rotationUnits::rev, 30, vex::velocityUnits::pct, true);
}
